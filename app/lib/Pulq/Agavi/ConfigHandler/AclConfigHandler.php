...
/**
 * ProjectAclConfigHandler parses configuration files that follow the pulq access_control markup.
 *
...
class AclConfigHandler extends \AgaviXmlConfigHandler
{
     ...
     */
    const XML_NAMESPACE = 'http://berlinonline.de/schemas/pulq/config/access_control/1.0';
