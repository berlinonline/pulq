...
/**
 * HeroAclConfigHandler parses configuration files that follow the midas access_control markup.
 *
 * @version    $Id: HeroAclConfigHandler.class.php 1013 2012-03-02 21:28:23Z tschmitt $
 * @author     Thorsten Schmitt-Rink
 * @package    Hero
 * @subpackage Agavi/ConfigHandler
 */
class HeroAclConfigHandler extends AgaviXmlConfigHandler
{
    /**
