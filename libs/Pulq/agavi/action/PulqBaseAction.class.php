...
/**
 * The PulqBaseAction serves as the base action to all actions implemented inside of this project.
 *
 * @version         $Id: PulqBaseAction.class.php 1013 2012-03-02 21:28:23Z tschmitt $
 * @copyright       BerlinOnline Stadtportal GmbH & Co. KG
 * @author          Thorsten Schmitt-Rink <tschmittrink@gmail.com>
 * @package         Pulq
 * @subpackage      Agavi/Action
 */
class PulqBaseAction extends AgaviAction
{
    /**
