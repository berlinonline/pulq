...
/**
 * The PulqZendAclSecurityUser is responseable for detecting required scripts and deploying them for your view.
 *
 * @version         $Id: PulqZendAclSecurityUser.class.php 1010 2012-03-02 20:08:23Z tschmitt $
 * @copyright       BerlinOnline Stadtportal GmbH & Co. KG
 * @author          Thorsten Schmitt-Rink <thorsten.schmitt-rink@berlinonline.de>
 * @package         Pulq
 * @subpackage      Agavi/User
 */
class PulqZendAclSecurityUser extends AgaviSecurityUser implements Zend_Acl_Role_Interface
{
    protected $zendAcl;
