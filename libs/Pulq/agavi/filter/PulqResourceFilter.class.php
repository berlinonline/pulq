...
/**
 * The PulqResourceFilter is responseable for detecting required scripts and deploying them for your view.
 *
 * @version         $Id: PulqResourceFilter.class.php 1065 2012-04-05 12:05:39Z tschmitt $
 ...
 */
class PulqResourceFilter extends AgaviFilter implements AgaviIGlobalFilter
{
    ...
    public function initialize(AgaviContext $context, array $parameters = array())
    {
        ...
        $this->config = new PulqResourceFilterConfig($parameters);
    }
    ...
    public function execute(AgaviFilterChain $filterChain, AgaviExecutionContainer $container)
    {
        ...
        $packer = new PulqResourcePacker(self::$modules, $this->curOutputType, $this->config);
        $packer->pack();
     ...
     *
     * @return PulqResourceFilterConfig
     */
    ...
    {
        $pubDir = $this->config->get(PulqResourceFilterConfig::CFG_PUB_DIR);
