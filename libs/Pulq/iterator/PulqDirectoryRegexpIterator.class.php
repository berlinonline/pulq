...
/**
 * The PulqFileSystemRegexpIterator lets you traverse files on the file system thereby applying
 * a given regexp to iterate only files that the expression.
 *
 * @version         $Id: PulqDirectoryRegexpIterator.class.php 1024 2012-03-03 15:35:16Z tschmitt $
 * @copyright       BerlinOnline Stadtportal GmbH & Co. KG
 * @author          Thorsten Schmitt-Rink <tschmittrink@gmail.com>
 * @package         Pulq
 * @subpackage      Iterator
 */
class PulqDirectoryRegexpIterator extends FilterIterator
{
