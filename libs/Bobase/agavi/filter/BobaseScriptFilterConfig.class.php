...
/**
 * The BobaseScriptFilterConfig provides access to the scripts.xml settings.
 *
 * @version         $Id: BobaseScriptFilterConfig.class.php 1010 2012-03-02 20:08:23Z tschmitt $
 * @copyright       BerlinOnline Stadtportal GmbH & Co. KG
 * @author          Thorsten Schmitt-Rink <tschmittrink@gmail.com>
 * @package         Bobase
 * @subpackage      Agavi/Filter
 */
class BobaseScriptFilterConfig
{
