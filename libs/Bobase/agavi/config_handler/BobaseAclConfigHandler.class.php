...
/**
 * BobaseAclConfigHandler parses configuration files that follow the midas access_control markup.
 *
 * @version    $Id: BobaseAclConfigHandler.class.php 1013 2012-03-02 21:28:23Z tschmitt $
 * @author     Thorsten Schmitt-Rink
 * @package    Bobase
 * @subpackage Agavi/ConfigHandler
 */
class BobaseAclConfigHandler extends AgaviXmlConfigHandler
{
    /**
