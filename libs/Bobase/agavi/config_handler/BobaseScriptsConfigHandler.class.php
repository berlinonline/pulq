...
/**
 * BobaseScriptsConfigHandler parses configuration files that follow the midas scripts.xsd markup.
 *
 * @version    $Id: BobaseScriptsConfigHandler.class.php 1013 2012-03-02 21:28:23Z tschmitt $
 * @author     Thorsten Schmitt-Rink
 * @package    Bobase
 * @subpackage Agavi/ConfigHandler
 */
class BobaseScriptsConfigHandler extends AgaviXmlConfigHandler
{
